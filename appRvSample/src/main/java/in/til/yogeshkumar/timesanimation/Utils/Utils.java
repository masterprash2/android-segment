...
public class Utils {
    ...
    public static float getDimensionFromDp(float dimenInDp, Activity context) {
        return TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, dimenInDp, context.getResources().getDisplayMetrics());
    }
