...
public class DiffUtil {
    ...
    public static class DiffResult {
        ...
        public void dispatchUpdatesTo(ItemControllerSource itemControllerSource) {
            this.dispatchUpdatesTo(new AdapterListUpdateCallback(itemControllerSource));
        }

        public void dispatchUpdatesTo(com.clumob.segment.controller.list.ListUpdateCallback updateCallback) {
            com.clumob.segment.controller.list.BatchingListUpdateCallback batchingCallback;
            if (updateCallback instanceof com.clumob.segment.controller.list.BatchingListUpdateCallback) {
                batchingCallback = (com.clumob.segment.controller.list.BatchingListUpdateCallback) updateCallback;
            } else {
        ...
        private void dispatchAdditions(List<DiffUtil.PostponedUpdate> postponedUpdates, com.clumob.segment.controller.list.ListUpdateCallback updateCallback, int start, int count, int globalIndex) {
            if (!this.mDetectMoves) {
